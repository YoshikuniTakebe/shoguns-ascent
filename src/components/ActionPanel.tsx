...
export const ActionPanel = () => {
  ...
  return (<div className="action-panel"><h3>Actions</h3>
    {gameState.currentPhase==='tea'&&<div className="tea-phase"><h4>Tea Ceremony - Alliances</h4><p className="phase-description">Each player takes a turn to propose or accept alliances. Player {gameState.teaTurnIndex + 1} of {gameState.players.length}.</p>
      ...
      {isMyTurn&&<button className="btn-primary advance-btn" onClick={doEndTeaTurn}>End My Tea Turn</button>}
    </div>}
