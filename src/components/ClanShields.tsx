...
const DragonflyShield = ({ color, size }: { color: string; size: number }) => (
  <svg width={size} height={size} viewBox="0 0 64 64" className="clan-shield">
    {/* Hexagonal shield */}
...
const FoxShield = ({ color, size }: { color: string; size: number }) => (
  <svg width={size} height={size} viewBox="0 0 64 64" className="clan-shield">
...
const LotusShield = ({ color, size }: { color: string; size: number }) => (
  <svg width={size} height={size} viewBox="0 0 64 64" className="clan-shield">
    {/* Circular shield with scalloped edge */}
    <circle cx="32" cy="32" r="28" fill="rgba(0,0,0,0.3)" stroke={color} strokeWidth="2.5"/>
...
const TurtleShield = ({ color, size }: { color: string; size: number }) => (
  <svg width={size} height={size} viewBox="0 0 64 64" className="clan-shield">
    {/* Octagonal shield */}
...
export const ClanShield = ({ clanId, size = 48 }: ClanShieldProps) => {
  ...
  switch (clanId) {
    ...
    case 'dragonfly': return <DragonflyShield color={color} size={size} />;
    case 'bonsai': return <BonsaiShield color={color} size={size} />;
    case 'fox': return <FoxShield color={color} size={size} />;
    case 'lotus': return <LotusShield color={color} size={size} />;
    case 'turtle': return <TurtleShield color={color} size={size} />;
    default: return null;
  }
};
