...
export const FistIcon = ({ size = 24, color = 'currentColor', className }: IconProps) => (
  <svg
    ...
    stroke="none"
  >
    <path d="M9 22 L9 16 C7.8 15.8 7 14.8 7 13.5 L7 9 C7 8.3 7.4 7.8 8 7.5 L8 5.5 C8 4.6 8.4 4 9 4 C9.6 4 10 4.6 10 5.5 L10 7.5 L10.2 4.2 C10.2 3.2 10.7 2.5 11.2 2.5 C11.7 2.5 12.2 3.2 12.2 4.2 L12 7.5 L12.5 4.5 C12.5 3.5 13 2.8 13.5 2.8 C14 2.8 14.5 3.5 14.5 4.5 L14.2 7.5 L14.5 5.5 C14.5 4.6 15 4 15.5 4 C16 4 16.5 4.6 16.5 5.5 L16.5 7.5 C17.1 7.8 17.5 8.3 17.5 9 L17.5 13.5 C17.5 14.8 16.7 15.8 15.5 16 L15.5 22 Z" />
  </svg>
);
