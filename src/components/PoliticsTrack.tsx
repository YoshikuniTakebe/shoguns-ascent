...
import { ToriiGateIcon } from './Icons';
import { WarSeal } from './ClanShields';
  ...
  const renderKamiIcon = (key: string) => (
    <div key={key} className="politics-phase-wrapper">
      <div className={`politics-track-kami${gameState.kamiResolutionActive ? ' active' : ''}`}>
        <ToriiGateIcon size={28} color="var(--accent-gold)" />
      </div>
      <span className="politics-phase-tooltip">{t('politics.kamiTurn')}</span>
    </div>
  );
  ...
  return (
    <div className="politics-track">
      ...
      <div className="politics-phase-wrapper">
        ...
        <span className="politics-phase-tooltip politics-phase-tooltip-tea" style={{ left: '150%' }}>{t('politics.teaCeremony')}</span>
      </div>
      ...
      <div className="politics-phase-wrapper">
        ...
        <span className="politics-phase-tooltip">{t('politics.battlePhase')}</span>
      </div>
